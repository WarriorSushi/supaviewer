    ...
    <div className="sticky top-12 md:top-16 z-30 glass mb-6">
      ...
      >
        <TabsList className="w-full grid grid-cols-3 h-9 md:h-10 rounded-none bg-transparent p-0">
          <TabsTrigger
            value="featured"
            className="gap-1.5 md:gap-2 text-xs md:text-sm rounded-none border-b-[2px] md:border-b-[2px] !border-b-transparent data-[state=active]:!border-b-[#F59E0B] data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:text-foreground hover:text-foreground"
          >
