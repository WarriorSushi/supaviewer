        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <Button
              type="button"
              variant="outline"
              className="w-full h-12 bg-white hover:bg-gray-50 text-gray-700 border-gray-200 hover:border-gray-300 font-semibold shadow-sm hover:shadow transition-all"
